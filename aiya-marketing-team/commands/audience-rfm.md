...
แบ่งกองลูกค้าของร้าน $ARGUMENTS โดยให้ agent วิว (mkt_research) เรียก skill **ใครก่อน (who-first)**

## ขั้นตอน

1. ให้ วิว (mkt_research) เรียก `customer_segments` ก่อนพูดอะไรทั้งสิ้น อ่านช่อง `dimensions` ตามกฎของ skill (ถ้า `dimensions=2` ต้องเตือนว่ายังไม่มีข้อมูลยอดซื้อ)
